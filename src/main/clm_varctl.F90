module clm_varctl
  ...
  logical, public            :: use_fates_canopy_damage = .false.      ! true => turn on canopy damage
  logical, public            :: use_fates_understory_damage = .false.  ! true => turn on understory damage
